...
import com.orion.portafolio2017.repository.LogRepository;
...
public class RequestTimeInterceptor extends HandlerInterceptorAdapter{
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
		...
		com.orion.portafolio2017.entity.Log log = new com.orion.portafolio2017.entity.Log(new Date(), auth.getDetails().toString(),username ,url);
